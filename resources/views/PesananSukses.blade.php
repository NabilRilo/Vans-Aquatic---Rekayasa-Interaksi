...
@section('title', 'Pesanan Berhasil Diproses!')
...
{{-- Anda mungkin tidak perlu file pesananSukses.css jika menggunakan style inline ini --}}
...
<div class="container mt-5 mb-5 order-success-container">
    <div class="card order-success-card text-center">
        <div class="card-body">
            ...
            <h2 class="card-title">🎉 Pesanan Anda Berhasil Diproses!</h2>
            
            <p class="lead text-dark">
                Terima kasih telah berbelanja.
            </p>
            <p class="text-muted mb-4">
                Pesanan Anda telah kami terima dan sedang diproses. Anda akan menerima notifikasi 
                saat pesanan mulai dikirim.
            </p>
